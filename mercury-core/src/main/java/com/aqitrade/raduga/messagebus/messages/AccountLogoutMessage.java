...
public class AccountLogoutMessage extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public AccountLogoutMessage() {}

  /**
   * All-args constructor.
   */
  public AccountLogoutMessage(String brokerId, Long accountID, String accountAuthId, String accountPassword, String createDate) {
  ...
  /** Creates a new AccountLogoutMessage RecordBuilder */
  public static Builder newBuilder() {
    return new Builder();
  }
  
  /** Creates a new AccountLogoutMessage RecordBuilder by copying an existing Builder */
  public static Builder newBuilder(Builder other) {
    return new Builder(other);
  }
  
  /** Creates a new AccountLogoutMessage RecordBuilder by copying an existing AccountLogoutMessage instance */
  public static Builder newBuilder(AccountLogoutMessage other) {
    return new Builder(other);
  }
  
  /**
   * RecordBuilder for AccountLogoutMessage instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AccountLogoutMessage>
    implements org.apache.avro.data.RecordBuilder<AccountLogoutMessage> {
    ...
    private Builder() {
      super(AccountLogoutMessage.SCHEMA$);
    }
    ...
    /** Creates a Builder by copying an existing AccountLogoutMessage instance */
    private Builder(AccountLogoutMessage other) {
            super(AccountLogoutMessage.SCHEMA$);
      if (isValidValue(fields()[0], other.brokerId)) {
        this.brokerId = data().deepCopy(fields()[0].schema(), other.brokerId);
        fieldSetFlags()[0] = true;
    ...
    @Override
    public AccountLogoutMessage build() {
      try {
        AccountLogoutMessage record = new AccountLogoutMessage();
