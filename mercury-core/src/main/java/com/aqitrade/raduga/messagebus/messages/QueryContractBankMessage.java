...
public class QueryContractBankMessage extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"QueryContractBankMessage\",\"namespace\":\"com.aqitrade.raduga.messagebus.messages\",\"fields\":[{\"name\":\"brokerId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"accountID\",\"type\":\"long\"},{\"name\":\"accountAuthId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"accountPassword\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"createDate\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public QueryContractBankMessage() {}

  /**
   * All-args constructor.
   */
  public QueryContractBankMessage(String brokerId, Long accountID, String accountAuthId, String accountPassword, String createDate) {
  ...
  /** Creates a new QueryContractBankMessage RecordBuilder */
  public static Builder newBuilder() {
    return new Builder();
  }
  
  /** Creates a new QueryContractBankMessage RecordBuilder by copying an existing Builder */
  public static Builder newBuilder(Builder other) {
    return new Builder(other);
  }
  
  /** Creates a new QueryContractBankMessage RecordBuilder by copying an existing QueryContractBankMessage instance */
  public static Builder newBuilder(QueryContractBankMessage other) {
    return new Builder(other);
  }
  
  /**
   * RecordBuilder for QueryContractBankMessage instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<QueryContractBankMessage>
    implements org.apache.avro.data.RecordBuilder<QueryContractBankMessage> {
    ...
    private Builder() {
      super(QueryContractBankMessage.SCHEMA$);
    }
    ...
    /** Creates a Builder by copying an existing QueryContractBankMessage instance */
    private Builder(QueryContractBankMessage other) {
            super(QueryContractBankMessage.SCHEMA$);
      if (isValidValue(fields()[0], other.brokerId)) {
        this.brokerId = data().deepCopy(fields()[0].schema(), other.brokerId);
        fieldSetFlags()[0] = true;
    ...
    @Override
    public QueryContractBankMessage build() {
      try {
        QueryContractBankMessage record = new QueryContractBankMessage();
