...
public class BankFutureTransferMessage extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"BankFutureTransferMessage\",\"namespace\":\"com.aqitrade.raduga.messagebus.messages\",\"fields\":[{\"name\":\"transferId\",\"type\":\"long\"},{\"name\":\"brokerId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"accountID\",\"type\":\"long\"},{\"name\":\"accountAuthId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"accountPassword\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"fundPassword\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"tradeCode\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"bankID\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"bankBranchID\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"bankPassword\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"secuPwdFlag\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"currencyID\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"tradeAmount\",\"type\":\"double\"}]}");
  ...
  @Deprecated public String fundPassword;
   ...
   */
  public BankFutureTransferMessage() {}

  /**
   * All-args constructor.
   */
  public BankFutureTransferMessage(Long transferId, String brokerId, Long accountID, String accountAuthId, String accountPassword, String fundPassword, String tradeCode, String bankID, String bankBranchID, String bankPassword, String secuPwdFlag, String currencyID, Double tradeAmount) {
  ...
  public Object get(int field$) {
    ...
    case 10: return secuPwdFlag;
    case 11: return currencyID;
    case 12: return tradeAmount;
  ...
  public void put(int field$, Object value$) {
    ...
    case 5: fundPassword = (String)value$; break;
    case 6: tradeCode = (String)value$; break;
    case 7: bankID = (String)value$; break;
    case 8: bankBranchID = (String)value$; break;
    case 9: bankPassword = (String)value$; break;
    case 10: secuPwdFlag = (String)value$; break;
    case 11: currencyID = (String)value$; break;
    case 12: tradeAmount = (Double)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  /**
   * Gets the value of the 'fundPassword' field.
   */
  ...
  /**
   * Sets the value of the 'fundPassword' field.
   * @param value the value to set.
   */
  public void setFundPassword(String value) {
    this.fundPassword = value;
  }
  ...
  /** Creates a new BankFutureTransferMessage RecordBuilder */
  public static Builder newBuilder() {
    return new Builder();
  }
  
  /** Creates a new BankFutureTransferMessage RecordBuilder by copying an existing Builder */
  public static Builder newBuilder(Builder other) {
    return new Builder(other);
  }
  
  /** Creates a new BankFutureTransferMessage RecordBuilder by copying an existing BankFutureTransferMessage instance */
  public static Builder newBuilder(BankFutureTransferMessage other) {
    return new Builder(other);
  }
  
  /**
   * RecordBuilder for BankFutureTransferMessage instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<BankFutureTransferMessage>
    implements org.apache.avro.data.RecordBuilder<BankFutureTransferMessage> {
    ...
    private Builder() {
      super(BankFutureTransferMessage.SCHEMA$);
    }
    ...
    private Builder(Builder other) {
      ...
      if (isValidValue(fields()[10], other.secuPwdFlag)) {
        this.secuPwdFlag = data().deepCopy(fields()[10].schema(), other.secuPwdFlag);
        fieldSetFlags()[10] = true;
      }
      if (isValidValue(fields()[11], other.currencyID)) {
        this.currencyID = data().deepCopy(fields()[11].schema(), other.currencyID);
        fieldSetFlags()[11] = true;
      }
      if (isValidValue(fields()[12], other.tradeAmount)) {
        this.tradeAmount = data().deepCopy(fields()[12].schema(), other.tradeAmount);
        fieldSetFlags()[12] = true;
      }
    }
    
    /** Creates a Builder by copying an existing BankFutureTransferMessage instance */
    private Builder(BankFutureTransferMessage other) {
            super(BankFutureTransferMessage.SCHEMA$);
      if (isValidValue(fields()[0], other.transferId)) {
        this.transferId = data().deepCopy(fields()[0].schema(), other.transferId);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'fundPassword' field */
    public Builder setFundPassword(String value) {
    ...
    /** Checks whether the 'fundPassword' field has been set */
    public boolean hasFundPassword() {
      return fieldSetFlags()[5];
    }
    
    /** Clears the value of the 'fundPassword' field */
    ...
    @Override
    public BankFutureTransferMessage build() {
      try {
        BankFutureTransferMessage record = new BankFutureTransferMessage();
        ...
        record.fundPassword = fieldSetFlags()[5] ? this.fundPassword : (String) defaultValue(fields()[5]);
        record.tradeCode = fieldSetFlags()[6] ? this.tradeCode : (String) defaultValue(fields()[6]);
        record.bankID = fieldSetFlags()[7] ? this.bankID : (String) defaultValue(fields()[7]);
        record.bankBranchID = fieldSetFlags()[8] ? this.bankBranchID : (String) defaultValue(fields()[8]);
        record.bankPassword = fieldSetFlags()[9] ? this.bankPassword : (String) defaultValue(fields()[9]);
        record.secuPwdFlag = fieldSetFlags()[10] ? this.secuPwdFlag : (String) defaultValue(fields()[10]);
        record.currencyID = fieldSetFlags()[11] ? this.currencyID : (String) defaultValue(fields()[11]);
        record.tradeAmount = fieldSetFlags()[12] ? this.tradeAmount : (Double) defaultValue(fields()[12]);
        return record;
      } catch (Exception e) {
