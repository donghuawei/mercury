...
public class MarketInstrumentAddinsQueryMessage extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"MarketInstrumentAddinsQueryMessage\",\"namespace\":\"com.aqitrade.raduga.messagebus.messages\",\"fields\":[{\"name\":\"brokerID\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"accountId\",\"type\":\"long\"},{\"name\":\"accountAuthId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"accountPassword\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public MarketInstrumentAddinsQueryMessage() {}

  /**
   * All-args constructor.
   */
  public MarketInstrumentAddinsQueryMessage(String brokerID, Long accountId, String accountAuthId, String accountPassword) {
  ...
  /** Creates a new MarketInstrumentAddinsQueryMessage RecordBuilder */
  public static Builder newBuilder() {
    return new Builder();
  }
  
  /** Creates a new MarketInstrumentAddinsQueryMessage RecordBuilder by copying an existing Builder */
  public static Builder newBuilder(Builder other) {
    return new Builder(other);
  }
  
  /** Creates a new MarketInstrumentAddinsQueryMessage RecordBuilder by copying an existing MarketInstrumentAddinsQueryMessage instance */
  public static Builder newBuilder(MarketInstrumentAddinsQueryMessage other) {
    return new Builder(other);
  }
  
  /**
   * RecordBuilder for MarketInstrumentAddinsQueryMessage instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MarketInstrumentAddinsQueryMessage>
    implements org.apache.avro.data.RecordBuilder<MarketInstrumentAddinsQueryMessage> {
    ...
    private Builder() {
      super(MarketInstrumentAddinsQueryMessage.SCHEMA$);
    }
    ...
    /** Creates a Builder by copying an existing MarketInstrumentAddinsQueryMessage instance */
    private Builder(MarketInstrumentAddinsQueryMessage other) {
            super(MarketInstrumentAddinsQueryMessage.SCHEMA$);
      if (isValidValue(fields()[0], other.brokerID)) {
        this.brokerID = data().deepCopy(fields()[0].schema(), other.brokerID);
        fieldSetFlags()[0] = true;
    ...
    @Override
    public MarketInstrumentAddinsQueryMessage build() {
      try {
        MarketInstrumentAddinsQueryMessage record = new MarketInstrumentAddinsQueryMessage();
