...
public class QueryAccountMarginCommissionMessage extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"QueryAccountMarginCommissionMessage\",\"namespace\":\"com.aqitrade.raduga.messagebus.messages\",\"fields\":[{\"name\":\"brokerId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"accountID\",\"type\":\"long\"},{\"name\":\"accountAuthId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"accountPassword\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"symbol\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public QueryAccountMarginCommissionMessage() {}

  /**
   * All-args constructor.
   */
  public QueryAccountMarginCommissionMessage(String brokerId, Long accountID, String accountAuthId, String accountPassword, String symbol) {
  ...
  /** Creates a new QueryAccountMarginCommissionMessage RecordBuilder */
  public static Builder newBuilder() {
    return new Builder();
  }
  
  /** Creates a new QueryAccountMarginCommissionMessage RecordBuilder by copying an existing Builder */
  public static Builder newBuilder(Builder other) {
    return new Builder(other);
  }
  
  /** Creates a new QueryAccountMarginCommissionMessage RecordBuilder by copying an existing QueryAccountMarginCommissionMessage instance */
  public static Builder newBuilder(QueryAccountMarginCommissionMessage other) {
    return new Builder(other);
  }
  
  /**
   * RecordBuilder for QueryAccountMarginCommissionMessage instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<QueryAccountMarginCommissionMessage>
    implements org.apache.avro.data.RecordBuilder<QueryAccountMarginCommissionMessage> {
    ...
    private Builder() {
      super(QueryAccountMarginCommissionMessage.SCHEMA$);
    }
    ...
    /** Creates a Builder by copying an existing QueryAccountMarginCommissionMessage instance */
    private Builder(QueryAccountMarginCommissionMessage other) {
            super(QueryAccountMarginCommissionMessage.SCHEMA$);
      if (isValidValue(fields()[0], other.brokerId)) {
        this.brokerId = data().deepCopy(fields()[0].schema(), other.brokerId);
        fieldSetFlags()[0] = true;
    ...
    @Override
    public QueryAccountMarginCommissionMessage build() {
      try {
        QueryAccountMarginCommissionMessage record = new QueryAccountMarginCommissionMessage();
