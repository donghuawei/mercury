...
public class QueryTransferSerialMessage extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public QueryTransferSerialMessage() {}

  /**
   * All-args constructor.
   */
  public QueryTransferSerialMessage(String brokerId, Long accountID, String accountAuthId, String accountPassword, String createDate) {
  ...
  /** Creates a new QueryTransferSerialMessage RecordBuilder */
  public static Builder newBuilder() {
    return new Builder();
  }
  
  /** Creates a new QueryTransferSerialMessage RecordBuilder by copying an existing Builder */
  public static Builder newBuilder(Builder other) {
    return new Builder(other);
  }
  
  /** Creates a new QueryTransferSerialMessage RecordBuilder by copying an existing QueryTransferSerialMessage instance */
  public static Builder newBuilder(QueryTransferSerialMessage other) {
    return new Builder(other);
  }
  
  /**
   * RecordBuilder for QueryTransferSerialMessage instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<QueryTransferSerialMessage>
    implements org.apache.avro.data.RecordBuilder<QueryTransferSerialMessage> {
    ...
    private Builder() {
      super(QueryTransferSerialMessage.SCHEMA$);
    }
    ...
    /** Creates a Builder by copying an existing QueryTransferSerialMessage instance */
    private Builder(QueryTransferSerialMessage other) {
            super(QueryTransferSerialMessage.SCHEMA$);
      if (isValidValue(fields()[0], other.brokerId)) {
        this.brokerId = data().deepCopy(fields()[0].schema(), other.brokerId);
        fieldSetFlags()[0] = true;
    ...
    @Override
    public QueryTransferSerialMessage build() {
      try {
        QueryTransferSerialMessage record = new QueryTransferSerialMessage();
