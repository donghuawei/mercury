...
public class QueryCashMessage extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"QueryCashMessage\",\"namespace\":\"com.aqitrade.raduga.messagebus.messages\",\"fields\":[{\"name\":\"brokerId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"accountID\",\"type\":\"long\"},{\"name\":\"accountAuthId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"accountPassword\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"createDate\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public QueryCashMessage() {}

  /**
   * All-args constructor.
   */
  public QueryCashMessage(String brokerId, Long accountID, String accountAuthId, String accountPassword, String createDate) {
  ...
  /** Creates a new QueryCashMessage RecordBuilder */
  public static Builder newBuilder() {
    return new Builder();
  }
  
  /** Creates a new QueryCashMessage RecordBuilder by copying an existing Builder */
  public static Builder newBuilder(Builder other) {
    return new Builder(other);
  }
  
  /** Creates a new QueryCashMessage RecordBuilder by copying an existing QueryCashMessage instance */
  public static Builder newBuilder(QueryCashMessage other) {
    return new Builder(other);
  }
  
  /**
   * RecordBuilder for QueryCashMessage instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<QueryCashMessage>
    implements org.apache.avro.data.RecordBuilder<QueryCashMessage> {
    ...
    /** Creates a Builder by copying an existing QueryCashMessage instance */
    private Builder(QueryCashMessage other) {
            super(QueryCashMessage.SCHEMA$);
      if (isValidValue(fields()[0], other.brokerId)) {
        this.brokerId = data().deepCopy(fields()[0].schema(), other.brokerId);
        fieldSetFlags()[0] = true;
    ...
    @Override
    public QueryCashMessage build() {
      try {
        QueryCashMessage record = new QueryCashMessage();
