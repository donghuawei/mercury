...
public class QueryAccountRegisterMessage extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"QueryAccountRegisterMessage\",\"namespace\":\"com.aqitrade.raduga.messagebus.messages\",\"fields\":[{\"name\":\"brokerId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"accountID\",\"type\":\"long\"},{\"name\":\"accountAuthId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"accountPassword\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"createDate\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public QueryAccountRegisterMessage() {}

  /**
   * All-args constructor.
   */
  public QueryAccountRegisterMessage(String brokerId, Long accountID, String accountAuthId, String accountPassword, String createDate) {
  ...
  /** Creates a new QueryAccountRegisterMessage RecordBuilder */
  public static Builder newBuilder() {
    return new Builder();
  }
  
  /** Creates a new QueryAccountRegisterMessage RecordBuilder by copying an existing Builder */
  public static Builder newBuilder(Builder other) {
    return new Builder(other);
  }
  
  /** Creates a new QueryAccountRegisterMessage RecordBuilder by copying an existing QueryAccountRegisterMessage instance */
  public static Builder newBuilder(QueryAccountRegisterMessage other) {
    return new Builder(other);
  }
  
  /**
   * RecordBuilder for QueryAccountRegisterMessage instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<QueryAccountRegisterMessage>
    implements org.apache.avro.data.RecordBuilder<QueryAccountRegisterMessage> {
    ...
    private Builder() {
      super(QueryAccountRegisterMessage.SCHEMA$);
    }
    ...
    /** Creates a Builder by copying an existing QueryAccountRegisterMessage instance */
    private Builder(QueryAccountRegisterMessage other) {
            super(QueryAccountRegisterMessage.SCHEMA$);
      if (isValidValue(fields()[0], other.brokerId)) {
        this.brokerId = data().deepCopy(fields()[0].schema(), other.brokerId);
        fieldSetFlags()[0] = true;
    ...
    @Override
    public QueryAccountRegisterMessage build() {
      try {
        QueryAccountRegisterMessage record = new QueryAccountRegisterMessage();
